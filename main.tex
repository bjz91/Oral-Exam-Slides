...
\begin{frame}{Difficulties}
    \begin{enumerate}
        \item Aim 1 {
            \begin{itemize}
                \item Incomplete considerations about cloud/snow-AOD interactions (fraction parameters may not be sufficient) \textcolor[rgb]{0.1,0.1,0.6}{[p\ref{frm:missing}]}
            \end{itemize}
        }
        \item Aim 2 {
            \begin{itemize}
                \item Measurement errors may not meet the equal variance assumption (heteroskedasticity) \textcolor[rgb]{0.1,0.1,0.6}{[p\ref{frm:error}]}
                \item Determination of the distance from EPA stations to nearby low-cost sensors \textcolor[rgb]{0.1,0.1,0.6}{[p\ref{frm:col}]}
            \end{itemize}
        }
        \item Aim 3 {
            \begin{itemize}
                \item Sample size and statistical power \textcolor[rgb]{0.1,0.1,0.6}{[p\ref{frm:power}]}
                \item Effects of other diseases on the estimated associations (stratification/co-pollutant analysis) \textcolor[rgb]{0.1,0.1,0.6}{[p\ref{frm:pri}]}
            \end{itemize}
        }
    \end{enumerate}
\end{frame}
